# Banner destacado vertical — Sin bordes
...
`references/banner/[Temporal] BCP - Banner destacado - Vertical - Sin Bordes.html`
...
- Fuente: `banner-destacado-vertical-sin-bordes.mjml`
- Compilado: `dist/banners/banner-destacado-vertical-sin-bordes/banner-destacado-vertical-sin-bordes.html`
